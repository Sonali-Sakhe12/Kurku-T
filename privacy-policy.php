...
<header class="navbar" id="navbar">
    ...
    <section class="text-white" style="margin: 10vw 10vw 5vw 10vw">
        <div class="translations-content-container">
            <div class="container">
                <div class="tab-content translations-content-item en visible" id="en">
                    ...
                    <ul>
                        ...
                        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Ayur Organic Pvt Ltd, D501, Visahl CHSL, Sir M V Road, Andheri East, Mumbai - 400069.</li>
                        ...
                        <li><strong>Website</strong> refers to Kurku-T, accessible from <a href="https://ayur.organic/" rel="external nofollow noopener" target="_blank">https://ayur.organic/</a></li>
          ...
          <ul>
            <li>
              <p>By email: info@ayurorganic.com</p>
            </li>
            <li>
              <p>By phone number: 9890380902</p>
            </li>
            <li>
              <p>By mail: D501, Vishal CHSL, Sir M V Road, Anderi East, Mumbai - 400069</p>
            </li>
          </ul>
        </div>
      </div>
  ...
  <!-- <p class="policy-labels"><span><a href="term-and-conditions.php" target="_blank">Terms & Conditions</a> | <a href="privacy-policy.php" target="_blank">Privacy Policy</a></span></p>
    <p class="creator-label" style="transform: translateX(-20px)">Powered by Traction Shastra &#x2022; 2024</p> -->
